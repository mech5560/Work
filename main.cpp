  ...
  for (int time_index=0; time_index<4e5; time_index++ )
    {
      ...
      */
      ...
      if (time_index%1000==0)
        {
          Print_3D_File (Arr.velocity_x_new,ldz,ldy,ldx,time_index,X);
          Print_3D_File (Arr.velocity_y_new,ldz,ldy,ldx,time_index,Y);
          Print_3D_File(Arr.velocity_z_new,ldz,ldy,ldx,time_index,Z);
          Print_2D_Data(Arr.velocity_z_new, Arr.dy,ldz,ldy,ldx,time_index,Z);
          cout<<time_index<<endl;
        }
