                   ...
                   double error, int L, int N, int& flag)
{
  ...
  //Next, allocate memmory for the vectors and matrices that will be
  ...
  //This vector corresponds to the  value  A*X, i.e. the multiplication
  //of A with the initial guess.
  ...
  /* Error analysis: The BCGC algorithm imlpemented herein uses the l^1
     norm as a termination criteria norm.

     In particular, if X^i denotes the solution computed at the step i,
     then the termination criteria is
